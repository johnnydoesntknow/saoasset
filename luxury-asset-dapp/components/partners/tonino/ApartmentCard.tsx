    ...
    <>
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 pt-4 mt-4">
          <div className="mb-3">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Price per sqm: {formatCurrency(Math.round(apartment.price / apartment.size))}
            </p>
          </div>
          <Button
            variant="primary"
          ...
          >
            {apartment.available ? 'Reserve Now' : 'Sold Out'}
          </Button>
        </div>
      </Card>
      ...
      <SimplePaymentModal
        ...
        item={{
          ...
          description: `${apartment.bedrooms} bedroom apartment. ${apartment.size} sqm on floor ${apartment.floor}.`
        }}
        onSuccess={() => {
