...
export const env = {
  ...
  kyc: {
    ...
    enabled: getBooleanEnvVar('NEXT_PUBLIC_ENABLE_KYC', false), // Disabled for São Tomé application
  },

  // São Tomé Program Configuration
  saotome: {
    enabled: true,
    name: 'São Tomé and Príncipe',
    description: 'Government Residency by Investment Program',
    processingTime: '90 days',
    opnLaunchPrice: 0.06, // OPN token launch price for staking calculations
    packages: {
      single: {
        price: 25000,
        opnAllocation: 416667, // 25000 / 0.06
      },
      couple: {
        price: 50000,
        opnAllocation: 833333, // 50000 / 0.06
      },
      family: {
        price: 100000,
        opnAllocation: 1666667, // 100000 / 0.06
      },
    },
  },
  ...
  // Feature Flags
  features: {
    kyc: false, // Not needed for São Tomé application
